...
func Test_AesCmac(t *testing.T) {
	...
	message := make([]byte, 0)
	expected_mac, _ := hex.DecodeString("bb1d6929e95937287fa37d129b756746")
...
func Test_AesCmac_Example2(t *testing.T) {
	...
	expected_mac, _ := hex.DecodeString("070a16b46b4d4144f79bdd9dd04a287c")
...
func Test_AesCmac_Example3(t *testing.T) {
	...
	expected_mac, _ := hex.DecodeString("dfa66747de9ae63030ca32611497c827")
	
	mac := AesCmac128(key, message)

	if !bytes.Equal(mac, expected_mac) {
		t.Logf("%s!=%s",hex.EncodeToString(mac),hex.EncodeToString(expected_mac))
       	t.Fail();
	}
...
func Test_AesCmac_Example4(t *testing.T) {
	...
	expected_mac, _ := hex.DecodeString("51f0bebf7e3b9d92fc49741779363cfe")
